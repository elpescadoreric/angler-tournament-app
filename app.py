...
if st.session_state.logged_user:
    ...
    with col_logo:
        st.image("https://i.imgur.com/RgxPgmP.png", width=150)
    with col_title:
...
page = st.sidebar.radio("Navigation", ["Login/Register", "Profile", "Events", "My Events", "Live Catch Feed", "Captains Directory"])
...
# Submit Catch page (only for Captains)
if page == "Submit Catch" and st.session_state.role == "Captain":
...
# Other pages (Live Catch Feed, Captains Directory, Events, My Events) – same as before
